...
12 consecutive experiments have failed to beat the current best.
...
These parts of the design have not changed in ANY of the last 12 experiments:
  - Output (lat, lon, confidence) (unchanged 12 rounds running)
  - Confusability-weighted training sampler (unchanged 12 rounds running)
