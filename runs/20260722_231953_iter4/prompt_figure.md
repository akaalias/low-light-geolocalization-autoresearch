...
- Read the experiment record from: `runs/20260722_231953_iter4/experiment.json`
- Write ONLY this output file: `runs/20260722_231953_iter4/figure.json` — a single JSON object of the
