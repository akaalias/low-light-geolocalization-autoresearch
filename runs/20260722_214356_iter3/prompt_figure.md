...
- Read the experiment record from: `runs/20260722_214356_iter3/experiment.json`
- Write ONLY this output file: `runs/20260722_214356_iter3/figure.json` — a single JSON object of the
