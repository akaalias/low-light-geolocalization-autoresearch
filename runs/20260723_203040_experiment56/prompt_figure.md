...
- Read the experiment record from: `runs/pending_experiment.json`
- Write ONLY this output file: `runs/20260723_203040_experiment56/figure.json` — a single JSON object of the
