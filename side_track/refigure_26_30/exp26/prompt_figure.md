...
- Read the experiment record from: `side_track/refigure_26_30/exp26/design.json`
- Write ONLY this output file: `side_track/refigure_26_30/exp26/figure.json` — a single JSON object of the
