...
- Read the experiment record from: `side_track/refigure_26_30/exp28/design.json`
- Write ONLY this output file: `side_track/refigure_26_30/exp28/figure.json` — a single JSON object of the
