...
## Paths for this run (resolve the placeholders referenced above)
- Read the experiment record from: `side_track/refigure_26_30/exp27/design.json`
- Write ONLY this output file: `side_track/refigure_26_30/exp27/figure.json` — a single JSON object of the
  form {"architecture_svg": "<svg …>"} and nothing else.
